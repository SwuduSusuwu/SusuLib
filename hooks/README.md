...
- [`./hooks/prepare-commit-message`](./prepare-commit-message) is [custom `prepare-commit-msg`](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks) (`git add ./tags` if tracked.)
