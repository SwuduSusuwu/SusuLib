...
SUSUWU_SETUP_OBJDIR() { #/* Usage: `SUSUWU_SETUP_OBJDIR "./obj/"` */
	if [ -z ${OBJDIR} ]; then
		OBJDIR="${1}"
		SUSUWU_SETUP_OBJDIR_OLD="\"$(SUSUWU_SH_CURRENT_VALUE "${OBJDIR}")\""
		SUSUWU_SETUP_OBJDIR_NEW="\"$(SUSUWU_SH_PROPOSED_VALUE "./objnew/")\""
...
SUSUWU_SETUP_BINDIR() { #/* Usage: `SUSUWU_SETUP_BINDIR "./bin/"` */
	if [ -z ${BINDIR} ]; then
		BINDIR="${1}"
		SUSUWU_SETUP_BINDIR_OLD="\"$(SUSUWU_SH_CURRENT_VALUE "${BINDIR}")\""
		SUSUWU_SETUP_BINDIR_NEW="\"$(SUSUWU_SH_PROPOSED_VALUE "./binnew/")\""
