...
Asof 2025-07-10 (this commit, which follows [commit 921dcc2bd4be3813ffb5190d52479a236d703a81](https://github.com/SwuduSusuwu/SusuLib/commit/921dcc2bd4be3813ffb5190d52479a236d703a81)), this repo switches to a new certificate[^4]. The previous certificates are not known as "compromised", but were used on numerous devices and are no longer trustable.
## Supported versions
...
If you found [normal issue(s), such as this](https://github.com/SwuduSusuwu/SusuLib/security/code-scanning/1882), use [this normal route to post about new issues](https://github.com/SwuduSusuwu/SusuLib/issues/new).
...
- through a [new private advisory](https://github.com/SwuduSusuwu/SusuLib/security/advisories/new),
...
[^4]: Asof this commit, which follows [commit 921dcc2bd4be3813ffb5190d52479a236d703a81](https://github.com/SwuduSusuwu/SusuLib/commit/921dcc2bd4be3813ffb5190d52479a236d703a81), [`./.ssh/sha256.sig`](./.ssh/sha256.sig) (and the [`./.ssh/allowed_signers`](./.ssh/allowed_signers) which `sha256.sig` produces) have a new certificate (`SHA256:8MXQK2Ms1FI4X3BSNbLuYAAMO3MXPQ7GsGH4kcXNDiY`). This footnote was last altered by the commit which introduces that new certificate. All commits which follow this commit must use that new certificate.
**TODO**; have [`./.ssh/setup.sh`](./.ssh/setup.sh) set `git` to warn if new commits use old certificates (don't know how to).
