...
[^5]: Asof this commit (which follows [commit dd9ef4c61da2c847c0d35af39678a371a9a10c49](https://github.com/SwuduSusuwu/SusuLib/commit/dd9ef4c61da2c847c0d35af39678a371a9a10c49)), [`./.ssh/sha256.sig`](./.ssh/sha256.sig) (and the [`./.ssh/allowed_signers`](./.ssh/allowed_signers) which `sha256.sig` produces) have a new certificate. All commits which follow that commit must use that new certificate (`SHA256:G6I98GU7oMXNmKB/k10nAlZo52bN9y17xvARXjblM2g`).
