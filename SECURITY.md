...
[^5]: Asof this commit (which follows [commit a690ee75ca38695580649eb21744245a7d3673d6](https://github.com/SwuduSusuwu/SusuLib/commit/a690ee75ca38695580649eb21744245a7d3673d6)), [`./.ssh/sha256.sig`](./.ssh/sha256.sig) (and the [`./.ssh/allowed_signers`](./.ssh/allowed_signers) which `sha256.sig` produces) have a new certificate. All commits which follow that commit must use that new certificate (`SHA256:G6I98GU7oMXNmKB/k10nAlZo52bN9y17xvARXjblM2g`).
