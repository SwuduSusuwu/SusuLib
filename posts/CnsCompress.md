...
[cxx/ClassCns.cxx](https://github.com/SwuduSusuwu/SusuLib/blob/trunk/cxx/ClassCns.cxx) ([HSOM](https://github.com/CarsonScott/HSOM) + [apxr_run](https://github.com/Rober-t/apxr_run)) is just templates for general-purpose [emulations](https://wikipedia.org/wiki/emulation) of neural mass.
