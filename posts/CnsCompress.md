...
```
To [contribute](https://github.com/SwuduSusuwu/SusuLib?tab=readme-ov-file#how-to-contribute) to this, submit [new pull requests](https://github.com/SwuduSusuwu/SusuLib/pulls) which reference [https://github.com/SwuduSusuwu/SusuLib/issues/2](https://swudususuwu.substack.com/p/future-plans-have-computers-do-most).
...
- [cxx/ClassCns.cxx](https://github.com/SwuduSusuwu/SusuLib/blob/trunk/cxx/ClassCns.cxx) ([HSOM](https://github.com/CarsonScott/HSOM) + [apxr_run](https://github.com/Rober-t/apxr_run)) is just templates for general-purpose [emulations](https://wikipedia.org/wiki/emulation) of neural tissue.
...
Because the `arxiv.org` pages do not list compression ratios, have doubts, but if someone has produced this, won't waste resources to reproduce this.
...
The compression ratio guesses are based on the amount of hours of visuals which humans can remember (plus reproduce close to the original); guess is that most of what humans view involves optical bandwidth of around 2gbps, but is compressed into the neocortex (into formats similar to text at around 2kbps, but not tokenized such as text is; neural tissue produces "circuits" which are more symbolic / conceptual), plus can reproduce around 82% of the specifics of sources (but losses are flattened, thus [you cannot know what was forgotten or misremembered](https://swudususuwu.substack.com/p/do-some-jurisdictions-still-trust#%C2%A7fallible-witnesses)):
...
- This section was introduced in response to [_Solar-Pro-2_'s review](https://github.com/SwuduSusuwu/SusuLib/issues/2#issuecomment-3141463645).
